...
const Form = () => {
  ...
  return (
    <View className="mt-1 w-full items-center">
      <Text className="font-md text-xl text-white font-md">
        Sign in to your account
      </Text>
      <View className="w-[85%] mt-10">
        <View className="mb-7">
          <Text className="ml-5 mb-3 text-gray-200">Email</Text>
          <TextInput
        ...
        <View className="mb-7">
          <Text className="ml-5 mb-3 text-gray-200">Password</Text>
          <TextInput
            className="bg-[#263159] border  text-white text-sm rounded-[50px] block w-full p-4 placeholder-white"
            placeholderTextColor="#000"
            containerStyle={{ marginTop: 10, backgroundColor: "white" }}
